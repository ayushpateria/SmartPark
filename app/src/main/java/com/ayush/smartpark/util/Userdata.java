...
public class Userdata {
    ...
    public static String getStringPref(Activity context, String key_val, String def_val) {
        SharedPreferences pref = context.getSharedPreferences("pref_"+key_val,MODE_PRIVATE);
        return pref.getString(key_val, def_val);
    }

    public static void setStringPref(Activity context, String key_val, String val) {
        SharedPreferences pref = context.getSharedPreferences("pref_"+key_val,MODE_PRIVATE);
    ...
    public static String getLongLat(Activity context, String def_val){
        return getStringPref(context, Constants.CURRENT_LOC, def_val);
    }

    public static void setLongLat(Activity context, String val){
        setStringPref(context, Constants.CURRENT_LOC, val) ;
    }

    public static void setStreet(Activity context, String val){
        setStringPref(context, Constants.CURRENT_ST, val) ;
    }
    public static String getStreet(Activity context, String def_val){
